<?php
namespace Ferenckrausz\Attoworld\Utility;
 ...
 * PublicationUtility
 */
class PublicationUtility extends \TYPO3\CMS\Extbase\Utility\ExtensionUtility {
    
    public function makepub($repository, $uid) {
        $array = array();

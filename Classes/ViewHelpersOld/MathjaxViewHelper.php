...
class MathjaxViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
    ...
    */
    public function render($string) {
        $string = str_replace('__MATHSPAN(','\(',$string);
        $string = str_replace(')__','\)',$string);
        $string = str_replace('mathrm','',$string);

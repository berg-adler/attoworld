...
/**
 * Test case for class \Ferenckrausz\Attoworld\Domain\Model\Book.
 *
...
{
	/**
	 * @var \Ferenckrausz\Attoworld\Domain\Model\Book
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Ferenckrausz\Attoworld\Domain\Model\Book();
	}

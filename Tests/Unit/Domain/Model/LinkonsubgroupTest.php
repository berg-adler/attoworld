...
/**
 * Test case for class \Ferenckrausz\Attoworld\Domain\Model\Linkonsubgroup.
 *
 ...
 */
class LinkonsubgroupTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \Ferenckrausz\Attoworld\Domain\Model\Linkonsubgroup
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Ferenckrausz\Attoworld\Domain\Model\Linkonsubgroup();
	}

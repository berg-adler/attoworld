...
/**
 * Test case for class \Ferenckrausz\Attoworld\Domain\Model\Publication.
 *
...
{
	/**
	 * @var \Ferenckrausz\Attoworld\Domain\Model\Publication
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Ferenckrausz\Attoworld\Domain\Model\Publication();
	}

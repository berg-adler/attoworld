...
/**
 * Test case for class \Ferenckrausz\Attoworld\Domain\Model\Newspaper.
 *
 ...
 */
class NewspaperTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \Ferenckrausz\Attoworld\Domain\Model\Newspaper
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Ferenckrausz\Attoworld\Domain\Model\Newspaper();
	}

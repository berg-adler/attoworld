...
/**
 * Test case for class \Ferenckrausz\Attoworld\Domain\Model\Magazin.
 *
 ...
 */
class MagazinTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \Ferenckrausz\Attoworld\Domain\Model\Magazin
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Ferenckrausz\Attoworld\Domain\Model\Magazin();
	}

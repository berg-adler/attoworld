...
/**
 * Test case for class \Ferenckrausz\Attoworld\Domain\Model\Personsubgroup.
 *
 ...
 */
class PersonsubgroupTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \Ferenckrausz\Attoworld\Domain\Model\Personsubgroup
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Ferenckrausz\Attoworld\Domain\Model\Personsubgroup();
	}

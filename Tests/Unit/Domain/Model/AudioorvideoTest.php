...
/**
 * Test case for class \Ferenckrausz\Attoworld\Domain\Model\Audioorvideo.
 *
 ...
 */
class AudioorvideoTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \Ferenckrausz\Attoworld\Domain\Model\Audioorvideo
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Ferenckrausz\Attoworld\Domain\Model\Audioorvideo();
	}

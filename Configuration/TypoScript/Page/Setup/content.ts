    ...
    1 {
        ...
        1 {
            ...
            NO {
                ...
                before.dataWrap = <li class="first index-{register:count_MENUOBJ}">|
                wrapItemAndSub = </li>
...
page {
    ...
    10 {
        ...
        file.stdWrap.cObject {
            ...
            default = TEXT
            default.value = typo3conf/ext/attoworld/Resources/Private/Layouts/subsite.html
            1 = TEXT
            1.value = typo3conf/ext/attoworld/Resources/Private/Layouts/subsite.html
        }
        variables {

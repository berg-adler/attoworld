...
return array(
    'ctrl' => array(
        'title' => 'LLL:EXT:attoworld/Resources/Private/Language/locallang_db.xlf:tx_attoworld_domain_model_newspaper',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('attoworld') . 'Resources/Public/Icons/tx_attoworld_domain_model_newspaper.gif'
    ),
    'interface' => array(
    ...
    'columns' => array(
        ...
        'l10n_parent' => array(
            ...
            'config' => array(
                ...
                'foreign_table' => 'tx_attoworld_domain_model_newspaper',
                'foreign_table_where' => 'AND tx_attoworld_domain_model_newspaper.pid=###CURRENT_PID### AND tx_attoworld_domain_model_newspaper.sys_language_uid IN (-1,0)',
            ),
        ),

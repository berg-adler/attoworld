...
return array(
	'ctrl' => array(
		'title'	=> 'LLL:EXT:attoworld/Resources/Private/Language/locallang_db.xlf:tx_attoworld_domain_model_audioorvideo',
		'label' => 'title',
		'tstamp' => 'tstamp',
		'crdate' => 'crdate',
		'cruser_id' => 'cruser_id',
		...
		'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('attoworld') . 'Resources/Public/Icons/tx_attoworld_domain_model_audioorvideo.gif'
	),
	'interface' => array(
	...
	'urlParameters' => array(
		...
		'act' => 'file'
                ...
                'pubtstamp' => array(
                    'label' => 'Timestamp of Publication',
                    'config' => array(
                        'type' => 'input',
                        'size' => '50',
                        'eval' => 'datetime',
                ...
                'file' => array(
                    ...
                    'config' => array(
                        'type' => 'group',
                        'internal_type' => 'file',
                        "allowed" => "pdf,gif,png,jpeg,jpg,mp4",
                        "max_size" => 50000,
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_attoworld_domain_model_audioorvideo.pid=###CURRENT_PID### AND tx_attoworld_domain_model_audioorvideo.sys_language_uid IN (-1,0)',
			),
		),

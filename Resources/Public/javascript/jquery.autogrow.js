...
(function(jQuery) {
	...
	jQuery.autogrow.fn.extend({
		...
		init: function() {			
			var self = this;	
                        console.log(this.textarea.outerHeight(true), parseFloat(this.textarea.css('max-height')));
                        
                        
                        if(this.textarea.outerHeight(true) > parseFloat(this.textarea.css('max-height'))) {
                            this.textarea.css({'overflow-y':'scroll', display: 'block'});
                        } else {
                            console.log('2');
